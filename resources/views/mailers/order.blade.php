                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/$order->shoppingCartID()')}}" target="_blank">Ver mas información de mi pedido.</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2019 Ecommerce_master, Todos los derechos recervados.</em>

																<strong>Our mailing address is:</strong>
																<br />
																Support@trizenit.com
                                                            </div>
                                                        </td>
                                                    </tr>
